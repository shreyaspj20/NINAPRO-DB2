...
aggregate_labels = np.load("aggregate_labels_300ms.npy")
aggregate_test_labels = np.load("aggregate_test_labels_300ms.npy")

reduced_feature_matrix = np.load("reduced_feature_matrix_300ms.npy")
reduced_test_feature_matrix = np.load("reduced_test_feature_matrix_300ms.npy")
